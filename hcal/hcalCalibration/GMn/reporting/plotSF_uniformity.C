...
void plotSF_uniformity( Int_t kine = 4 ){
  ...
  TFile *fsf = TFile::Open(Form("qreplay_sbs%d.root",kine));
  TH2D *hsfvid = (TH2D*)fsf->Get("hSampFracvID");
  TH2D *hsfvrow = (TH2D*)fsf->Get("hSampFracvRow");
  TH2D *hsfvcol = (TH2D*)fsf->Get("hSampFracvCol");
