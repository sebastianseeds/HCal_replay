...
{   
  ...
  std::string out_path = out_dir + Form("/hcal_calibrations/pass%d/diagnostics/timingdiag_%s_sbs%d_pass%d.root",pass,experiment,kine,pass);
  //std::string out_path = outdir_path + Form("/hcal_calibrations/pass%d/diagnostics/timingdiag_%s_conf%d_pass%d_%d_to_%d_exclude_%d_to_%d.root",pass,experiment,kine,pass,run_b,run_e,run_exclude_b,run_exclude_e);
  ...
  TH2D *hatimerun = new TH2D( "hatimerun", "HCal-Hodo Atime vs Run Num; Run; ns", nruns, 0, nruns, 200, -50, 50 );
  TH2D *hatimerow = new TH2D( "hatimerow", "HCal-Hodo Atime vs HCal Row; Row; ns", hcal::maxHCalRows, 0, hcal::maxHCalRows, 200, -50, 50 );
  TH2D *hatimecol = new TH2D( "hatimecol", "HCal-Hodo Atime vs HCal Col; Col; ns", hcal::maxHCalCols, 0, hcal::maxHCalCols, 200, -50, 50 );
  TH2D *hatimeid = new TH2D( "hatimeid", "HCal-Hodo Atime vs HCal ID; ID; ns", hcal::maxHCalChan, 0, hcal::maxHCalChan, 200, -50, 50 );
  TH2D *hatimex = new TH2D( "hatimex", "HCal-Hodo Atime vs HCal X; Row; ns", 500, -3, 2, 200, -50, 50 );
  TH2D *hatimey = new TH2D( "hatimey", "HCal-Hodo Atime vs HCal Y; Row; ns", 400, -2, 2, 200, -50, 50 );

  TH2D *hatimerun_bc = new TH2D( "hatimerun_bc", "HCal-Hodo Atime vs Run Num (intime cluster); Run; ns", nruns, 0, nruns, 200, -50, 50 );
  TH2D *hatimerow_bc = new TH2D( "hatimerow_bc", "HCal-Hodo Atime vs HCal Row (intime cluster); Row; ns", hcal::maxHCalRows, 0, hcal::maxHCalRows, 200, -50, 50 );
  TH2D *hatimecol_bc = new TH2D( "hatimecol_bc", "HCal-Hodo Atime vs HCal Col (intime cluster); Col; ns", hcal::maxHCalCols, 0, hcal::maxHCalCols, 200, -50, 50 );
  TH2D *hatimeid_bc = new TH2D( "hatimeid_bc", "HCal-Hodo Atime vs HCal ID (intime cluster); ID; ns", hcal::maxHCalChan, 0, hcal::maxHCalChan, 200, -50, 50 );
  TH2D *hatimex_bc = new TH2D( "hatimex_bc", "HCal-Hodo Atime vs HCal X (intime cluster); Row; ns", 500, -3, 2, 200, -50, 50 );
  TH2D *hatimey_bc = new TH2D( "hatimey_bc", "HCal-Hodo Atime vs HCal Y (intime cluster); Row; ns", 400, -2, 2, 200, -50, 50 );

  TH2D *htimerun = new TH2D( "htimerun", "HCal-Hodo Time vs Run Num; Run; ns", nruns, 0, nruns, 200, -50, 50 );
  TH2D *htimerow = new TH2D( "htimerow", "HCal-Hodo Time vs HCal Row; Row; ns", hcal::maxHCalRows, 0, hcal::maxHCalRows, 200, -50, 50 );
  TH2D *htimecol = new TH2D( "htimecol", "HCal-Hodo Time vs HCal Col; Col; ns", hcal::maxHCalCols, 0, hcal::maxHCalCols, 200, -50, 50 );
  TH2D *htimeid = new TH2D( "htimeid", "HCal-Hodo Time vs HCal ID; ID; ns", hcal::maxHCalChan, 0, hcal::maxHCalChan, 200, -50, 50 );
  TH2D *htimex = new TH2D( "htimex", "HCal-Hodo Atime vs HCal X; Row; ns", 500, -3, 2, 200, -50, 50 );
  TH2D *htimey = new TH2D( "htimey", "HCal-Hodo Atime vs HCal Y; Row; ns", 400, -2, 2, 200, -50, 50 );

  TH2D *htimerun_bc = new TH2D( "htimerun_bc", "HCal-Hodo Time vs Run Num (intime cluster); Run; ns", nruns, 0, nruns, 200, -50, 50 );
  TH2D *htimerow_bc = new TH2D( "htimerow_bc", "HCal-Hodo Time vs HCal Row (intime cluster); Row; ns", hcal::maxHCalRows, 0, hcal::maxHCalRows, 200, -50, 50 );
  TH2D *htimecol_bc = new TH2D( "htimecol_bc", "HCal-Hodo Time vs HCal Col (intime cluster); Col; ns", hcal::maxHCalCols, 0, hcal::maxHCalCols, 200, -50, 50 );
  TH2D *htimeid_bc = new TH2D( "htimeid_bc", "HCal-Hodo Time vs HCal ID (intime cluster); ID; ns", hcal::maxHCalChan, 0, hcal::maxHCalChan, 200, -50, 50 );
  TH2D *htimex_bc = new TH2D( "htimex_bc", "HCal-Hodo Time vs HCal X (intime cluster); Row; ns", 500, -3, 2, 200, -50, 50 );
  TH2D *htimey_bc = new TH2D( "htimey_bc", "HCal-Hodo Time vs HCal Y (intime cluster); Row; ns", 400, -2, 2, 200, -50, 50 );
