...
const Double_t tw_p0_llim = 1.;
const Double_t tw_p0_ulim = 6.;
const Double_t tw_p1_llim = 1.;
const Double_t tw_p1_ulim = 9.;
const Double_t tw_p2_llim = -10;
const Double_t tw_p2_ulim = 10;

// traditional fit tw fit
const Double_t trad_p0_llim = -0.5;
const Double_t trad_p0_ulim = 0.5;
const Double_t trad_p1_llim = 0.05;
const Double_t trad_p1_ulim = 4.;
const Double_t trad_p2_llim = 0.4;
const Double_t trad_p2_ulim = 0.6;

//pol1 tdc tw fit parameters
const Double_t p0_set = 3.;
const Double_t p1_set = -3.;
const Double_t p1_ll = -10.;
const Double_t p1_ul = -0.01;
...
void timewalk( const char *experiment = "gmn", Int_t config = 7, bool qreplay = false, Int_t pass = 0 ){
  ...
  TF1 *fitadct_pol = new TF1( "fitadct_pol", util::g_lfit, fit_ll, fit_ul, 2 );
  fitadct_pol->SetParameters(p0_set,p1_set);

  fitadct_pol->SetParLimits(1,p1_ll,p1_ul);

  hadct_polclone->Fit("fitadct_pol","WQ","",fit_ll,fit_ul);
