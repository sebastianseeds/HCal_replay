...
// Thu Mar  2 19:10:01 2023 by ROOT version 6.24/06
// from TTree T/Geant4 SBS Simulation
// found on file: gmn_sbs4_v2_job_1.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<int>     *Harm_HCal_dighit_adc;
   vector<int>     *Harm_HCal_dighit_samp;
   ...
   vector<int>     *Earm_BBPS_dighit_samp;
   vector<int>     *Earm_BBPS_dighit_tdc;
   Int_t           Earm_BBSH_dighit_nchan;
   vector<int>     *Earm_BBSH_dighit_chan;
   vector<int>     *Earm_BBSH_dighit_adc;
   vector<int>     *Earm_BBSH_dighit_samp;
   vector<int>     *Earm_BBSH_dighit_tdc;
   ...
   vector<int>     *Earm_BBGEM_dighit_adc;
   vector<int>     *Earm_BBGEM_dighit_samp;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("gmn_sbs4_v2_job_1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("gmn_sbs4_v2_job_1.root");
      }
      f->GetObject("T",tree);
