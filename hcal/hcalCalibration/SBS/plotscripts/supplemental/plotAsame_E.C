//sseeds 4.19.23 - script to plot E histos (all kinematics)
...
void plotAsame_E( ){
  ...
  TCanvas *c1 = new TCanvas("c1","G4SBS Cluster Energy Results",1600,1200);
  c1->Divide(2,1);
  ...
  auto hsmc = new THStack("hsmc","HCal Cluster Energy (MC)");
