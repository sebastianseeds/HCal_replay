...
void rf_study( const char *configfilename="srf_study.cfg"){
  ...
  // Declare outfile
  TFile *fout = new TFile( "rfStudyOUT.root", "RECREATE" );
  ...
  for(Long64_t nevent = 0; nevent<Nevents; nevent++){
    ...
    */
    ...
    Double_t RFmod = std::fmod(RF_time,2);
    hTRF->Fill(RF_time);
    hTRFmod->Fill(RFmod);
    ...
    if( Rle_trYtime!=-1000.&&Rle_trYtime!=-1000. ){
