...
void ecal_blockE_spectra( Int_t kine=-1){
 ...
 // Reading all relevant config files for ld2
  ...
  TH2D *hSampFracID = new TH2D( "hSampFracID","W2 Cut HCal Cluster E / Expected KE vs ID", 288, 0, 288, 400, 0., 1. );
  TH1D *hHCALblkpC = new TH1D( "hHCALblkpC","HCal Cluster Element pC", 400, 0., 100. );
  TH1D *hHCALblkspC = new TH1D( "hHCALblkpC","HCal Cluster Seed pC", 400, 0., 100. );
  TH2D *hHCALblkpCID = new TH2D( "hHCALblkpCID","HCal Cluster blk pC vs ID", 288, 0, 288, 400, 0., 100. );
  TH2D *hHCALblkpCID_h = new TH2D( "hHCALblkpCID_h","HCal Cluster blk pC vs ID (LH2)", 288, 0, 288, 400, 0., 100. );
  TH2D *hHCALblkpCID_d = new TH2D( "hHCALblkpCID_d","HCal Cluster blk pC vs ID (LD2)", 288, 0, 288, 400, 0., 100. );
  ...
  for( Int_t f=0; f<nfset_lh2[kIdx]; f++ ){
	...
	if( pass0 ){
	  ...
	  //cout << blkE/gOldConst_pass0[blkid];
	}else{
