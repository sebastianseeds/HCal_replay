  ...
  for(int i=0; i<kNcell; i++){
	...
	htDiff[i]->Fit("gaus","Q","",-80,-60);
      ...
      */
      ...
      if( i==4 || i==5 || i==7 || i==16 || i==17 || i==18 || i==19 || i==28 || i==29 || i==30 || i==31 || i==67 ){
	htDiff[i]->Fit("gaus","Q","",-85,-65);
      }else if( i==6 || i==40 || i==41 || i==42 || i==43 || i==48 || i==49 || i==50 || i==51 || i==56 || i==57 || i==58 || i==59 || i==66 || i==70 ){
	htDiff[i]->Fit("gaus","Q","",-80,-60);
      }else if( i==12 ){
	htDiff[i]->Fit("gaus","Q","",-45,-25);
      }else if( i==23 || i==36 || i==60 ){
	htDiff[i]->Fit("gaus","Q","",-60,-40);
      }else if( i==37 ){
	htDiff[i]->Fit("gaus","Q","",-70,-40);
      }else if( i==52 || i==53 || i==54 || i==55 || i==64 || i==65 ){
