// S.Seeds. 11.12.22 This script will estimate the energy of the elastically scattered electron and proton (e-p)
// taking into consideration the angular acceptance of BBSH for a proton or neutron target.
...
const Double_t ff = 0.05; // Added smearing factor to account for beam energy fluctuations and fermi motion
...
void GEnElasPeak( Double_t E_beam, Double_t BB_angle, Double_t BB_distance, Double_t Q2, Double_t hcal_angle, Double_t hcal_distance ){
